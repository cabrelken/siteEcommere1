    ...
    <section class="cart_area">
        <div class="container">
            ...
            <div class="cart_inner">
                             ...
                             <tr>
                                ...
                                <td>
                                    <div class="product_count">
                                        <input disabled type="text" name="qty" id="sst" maxlength="12" value="*{{ $product->qty}}" title="Quantity:"
                ...
                @else
                   <h3 class="my-3 text-center">No item in shopping cart </h>
        ...
        <div class="single-product-slider">
            <div class="container">
                @if(Cart::instance('save')->count()> 0)
                    <h2 class="text-center my-5">{{Cart::instance('save')->count()}} item(s) savegarder pour plus tard</h2>
                    <div class="row">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <div class="prd-bottom">
                                            ...
                                            <form action="{{route('save.destroy', $product->rowId)}}" method="POST">
                                                ...
                                                <button type="submit" class="btn bnt-link">Remove</button>
                                            </form>
                                            <form action="{{route('save.store', $product->rowId)}}" method="POST">
                                                {{csrf_field()}}
                                            
                                                <button type="submit" class="btn bnt-link">Move to cart</button>
                                            </form>
                                        </div>    
                                    </div>        
                                </div>
